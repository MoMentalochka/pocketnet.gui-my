...
//blocking
____loclib.blockinglimit_100 = "Нельзя выбрать более 100 пользователей за раз"
____loclib.blockingdisclaimer = "Вы хотите также заблокировать связанные учетные записи? Делайте это только для подозреваемых ботов."
____loclib.blockingsuccess = "Блокировка прошла успешно"
____loclib.blockinginprogress = "В данный момент выполняется множественная блокировка, попробуйте позже"
...
____loclib.regdate = "Дата регистрации";
____loclib.stime = "Время";
____loclib.ratings = "Оценок";
